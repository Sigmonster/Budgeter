namespace Budgeter.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            Sql("ALTER TABLE dbo.Accounts ADD ReconciledBalance Decimal(18,2) NULL SELECT SUM(Amount) FROM [Transactions] WHERE IsReconciled = 1 or IsActive = 1 or IsVoid=0");
